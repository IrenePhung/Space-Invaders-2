...
public class Player implements Moveable, Renderable, Prototype<Player> {
    ...
    public Player(Vector2D position, double health, double velocity, Image image) {
    ...
    public Player cloneObject(){
        return new Player(this.position,this.health,this.velocity,this.image);
    }
}
